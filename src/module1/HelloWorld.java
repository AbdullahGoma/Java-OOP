...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		size(900, 600, P2D);  // Set up the Applet window to be 900x600
		...
		//31.167356806481315, 31.80484438101269 for my location
//	    map1.zoomAndPanTo(zoomLevel, new Location(32.9f, -117.2f));
//	    map2.zoomAndPanTo(zoomLevel, new Location(31.167356806481315f, 31.80484438101269f));
