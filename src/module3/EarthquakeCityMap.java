...
//	    List<SimplePointMarker> markers = new ArrayList<SimplePointMarker>();
	    ...
	    //PointFeature is a subclass of (inherits from) Feature.
	    for(PointFeature eq: earthquakes) {
    	System.out.println(eq.getProperties());
        }
//	    if (earthquakes.size() > 0) {
//	    	PointFeature f = earthquakes.get(0);
//	    	System.out.println(f.getProperties()); //getProperties(): HashMap<String,Object>
//	    	Object magObj = f.getProperty("magnitude"); //getProperty(String key): Object
...
//	    }
	    ...
	    for(PointFeature eq: earthquakes) {
	    	//SimplePointMarkers are used to display the "dots" on the map.
